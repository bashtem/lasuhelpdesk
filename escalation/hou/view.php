...
<ul  class="pagination pagination-sm">
		...
		echo	"
        <li><a href=\"#\"  onclick=\"pages($page_no-1,'$sub_id');\">Previous</a></li>";		
		}
		for($x=1;$x<=$pages;$x++){
		echo ($page_no==$x)? "<li style='color:green'><a   href='#' onclick=\"pages('$x','$sub_id');\" ><b style=\"color:red\">$x</b></a></li>" : "<li><a href='#' onclick=\"pages('$x','$sub_id');\" >$x</a></li>";
		}
		if($page_no<$pages){
		echo "<li><a href=\"#\"  onclick=\"pages($page_no+1,'$sub_id');\"  >Next</a></li>";
		}
