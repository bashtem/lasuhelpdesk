                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                       <!--  <select hidden name='acc_type' class='form-control'>
                                         ...
                                         <input hidden type="text" name="acc_type" value="unit_rep">
                                    </div>
                                </div>      

                                <div class="form-group push-up-30">
                                     <div class="col-md-12 text-center">
                                         <input type="submit" name="add_agent" class="btn btn-success" value="Add Schedule Officer">
                                    </div>
                                </div>
